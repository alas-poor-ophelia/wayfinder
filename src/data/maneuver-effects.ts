...
export const MANEUVER_EFFECTS: Record<string, ManeuverEffect> = {
  ...
  "golden-lion:encouraging-roar": {
    modifiers: [
      { target: "attack.all", type: "morale", value: 2, source: "Encouraging Roar" },
      { target: "damage.all", type: "morale", value: 2, source: "Encouraging Roar" },
    ],
  ...
  "primal-fury:skirmisher-s-stance": {
    modifiers: [
      { target: "ac.all", type: "dodge", value: 2, source: "Skirmisher's Stance" },
    ],
    note: "+2 dodge to AC",
  },
  ...
  "mithral-current:flowing-water-stance": {
    modifiers: [
      { target: "ac.all", type: "dodge", value: 4, source: "Flowing Water Stance" },
    ],
    note: "+4 dodge to AC",
  },
  ...
  "iron-tortoise:mithral-tortoise-stance": {
    modifiers: [
      { target: "ac.all", type: "dodge", value: 2, source: "Mithral Tortoise Stance" },
      { target: "cmd", type: "dodge", value: 2, source: "Mithral Tortoise Stance" },
    ],
  ...
  "thrashing-dragon:inner-sphere-stance": {
    modifiers: [
      { target: "ac.all", type: "dodge", value: 2, source: "Inner Sphere Stance" },
      { target: "save.will", type: "morale", value: 2, source: "Inner Sphere Stance" },
    ],
  ...
  "silver-crane:silver-crane-waltz": {
    modifiers: [
      { target: "ac.all", type: "insight", value: 2, source: "Silver Crane Waltz" },
      { target: "save.ref", type: "insight", value: 2, source: "Silver Crane Waltz" },
    ],
